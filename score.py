...
tag  = Forensics
pointValue = 10
parameters = forensic1.txt:french_horn
...
tag = User Management
pointValue = 1
parameters = marcus timothy angel simon judah
